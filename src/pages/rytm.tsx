  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <div className="text-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800">RYTM</h2>
      </div>

      <div className="space-y-6">
        <div className="bg-gray-50 p-4 rounded-lg">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Privacy Policy</h1>
          <p className="text-gray-600 mb-4">Last updated: October 27, 2023</p>
          <p className="text-gray-700 mb-4">
            This Privacy Policy describes Our policies and procedures on the collection, use, and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
          </p>
          <p className="text-gray-700 mb-4">
            We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank" className="text-blue-500 hover:underline">Privacy Policy Generator</a>.
          </p>
          <p className="text-gray-700 mb-4">
            The application uses <b>Youtube</b> APIs, also view the <a href="https://www.youtube.com/t/terms?hl=it" target="_blank" className="text-blue-500 hover:underline">terms and conditions</a> and <a href="http://www.google.com/policies/privacy" target="_blank" className="text-blue-500 hover:underline">privacy policy</a> of the owner of the implemented service.
          </p>

          <h2 className="text-xl font-bold text-gray-800 mt-6">Interpretation and Definitions</h2>
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Interpretation</h3>
          <p className="text-gray-700 mb-4">
            The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
          </p>

          <h3 className="text-lg font-semibold text-gray-800 mt-4">Definitions</h3>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><p><strong>Application</strong> refers to RYTM, the software program provided by the Company.</p></li>
            <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to RYTM.</p></li>
          ...
          <h2 className="text-xl font-bold text-gray-800 mt-6">Collecting and Using Your Personal Data</h2>
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Types of Data Collected</h3>
          <h4 className="text-base font-medium text-gray-800 mt-2">Personal Data</h4>
          <p className="text-gray-700 mb-4">
          ...
          <h4 className="text-base font-medium text-gray-800 mt-4">Usage Data</h4>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Use of Your Personal Data</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Retention of Your Personal Data</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Transfer of Your Personal Data</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Delete Your Personal Data</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Disclosure of Your Personal Data</h3>
          <h4 className="text-base font-medium text-gray-800 mt-2">Business Transactions</h4>
          <p className="text-gray-700 mb-4">
            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
          </p>
          <h4 className="text-base font-medium text-gray-800 mt-2">Law enforcement</h4>
          <p className="text-gray-700 mb-4">
            Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>
          <h4 className="text-base font-medium text-gray-800 mt-2">Other legal requirements</h4>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mt-4">Security of Your Personal Data</h3>
          <p className="text-gray-700 mb-4">
            The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
          </p>

          <h2 className="text-xl font-bold text-gray-800 mt-6">Children's Privacy</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-xl font-bold text-gray-800 mt-6">Links to Other Websites</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-xl font-bold text-gray-800 mt-6">Changes to this Privacy Policy</h2>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><p>By email: riccardoventurini220@gmail.com</p></li>
            <li><p>By visiting this page on our website: <a href="https://riccardoventurini.dev/" rel="external nofollow noopener" target="_blank" className="text-blue-500 hover:underline">https://riccardoventurini.dev/</a></p></li>
          </ul>
        </div>
      </div>
    </div>
