  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <div className="text-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800">How I use your data in my website?</h2>
      </div>

      <div className="space-y-6">
        <div className="bg-gray-50 p-4 rounded-lg">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Privacy Policy</h1>
          <p className="text-gray-600 mb-4">Last updated: July 02, 2024</p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to riccardoventurini.dev.</p></li>
            ...
            <li><p><strong>Website</strong> refers to riccardoventurini.dev, accessible from <a href="http://www.riccardoventurini.dev" rel="external nofollow noopener" target="_blank" className="text-blue-500 hover:underline">http://www.riccardoventurini.dev</a></p></li>
          ...
          <h4 className="text-base font-medium text-gray-800 mt-4">Tracking Technologies and Cookies</h4>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><p>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__ text-blue-500 hover:underline" data-cfemail="f88a919b9b998a9c97868e959d9d98b89d9991959cd69b9795">[email protected]</a></p></li>
          </ul>
        </div>
      </div>
    </div>
